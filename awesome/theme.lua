...
theme.bg_focus      = "#d3a625"
theme.bg_normal     = "#137a7f"
theme.bg_urgent     = "#aacc00"
theme.bg_minimize   = "#9600ff"
theme.bg_systray    = theme.bg_normal

theme.fg_normal     = "#fcfce8"
theme.fg_focus      = "#fffbb6"
theme.fg_urgent     = "#ffdef5"
