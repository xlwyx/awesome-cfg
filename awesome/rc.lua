...
-- found (e.g. lgi). If LuaRocks is not installed, do nothing.
  ...
  globalkeys = gears.table.join(
    ...
    {description = "focus previous by index", group = "client"}
      ...
      awful.util.spawn("thonny") end,
              {description = "Thonny", group = "applications"}),
      ...
      awful.util.spawn("xlockmore") end,
              {description = "slock", group = "utilities"}),
  ...
  awful.rules.rules = {
    ...
    { rule_any = {
        ...
        role = {
          "AlarmWindow",  -- Geary's calendar.
          "ConfigManager",  -- Geary's about:config.
...
awful.spawn.with_shell("picom -cCGF")
awful.spawn.with_shell("~/./pipewire-pulse")
awful.spawn.with_shell("feh --bg-scale ~/Pictures/piccas_img/Adventure-time.jpg")
awful.spawn.with_shell("fcitx -s 3")
